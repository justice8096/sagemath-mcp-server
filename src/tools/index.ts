...
export { registerMatrixOpsTool } from "./matrix.js";
export { registerPlotTool } from "./plot.js";
export { registerLatexConvertTool } from "./latex.js";
export { registerNumberTheoryTool } from "./number-theory.js";